<div align="center">
     ...
     <img src="ai-banner-v2.svg" alt="Ratnesh Pathak — animated AI neural network banner" width="100%"/>
...
| 🎓 SGPA | 📖 Research Papers | 🏅 Project Exam Score | 📚 Certifications | 🧩 LeetCode Badges | 🚀 Hackathons |
| :---: | :---: | :---: | :---: | :---: | :---: |
| **9.36** | **3 Published** | **150/150** | **110+** | **23** | **2× Finalist** |
...
> End-to-end financial sentiment analysis and market intelligence platform combining NLP, machine learning, financial news, market data, and actionable signal generation.
...
<p align="center">
  <img src="https://github.com/RatneshPathak/FinSentAI/blob/main/docs/screenshots/FinSentAI-dashboard.jpg?raw=true" alt="FinSentAI Dashboard" width="90%">
</p>
...
> Full-stack AI-powered contract analysis platform for reviewing contracts, flagging risk, explaining clauses, generating redlines, and chatting with an AI assistant about the contract.
...
* 🌱 Env-based API key management, feature-branch Git workflow
...
👉 **[View Repository →](https://github.com/RatneshPathak/crowd_safety_ai)**
...
**🛠️ Stack:** `Power BI`
👉 **[View Repository →](https://github.com/RatneshPathak/Power-BI-dashboard)**
...
**🛠️ Stack:** `Python`
👉 **[View Repository →](https://github.com/RatneshPathak/Python-Practice)**
...
> Full-stack travel planning app for organizing trips, managing activities and budgets, with auth, dashboards, and external service integrations.

**✨ Highlights**
* 🔐 JWT-based auth, trip creation & management, admin panel
* 💰 Budget management, activity management, analytics endpoints
* 🌦️ Weather, ✈️ flight, 📍 geocoding, and 💱 currency conversion integrations
* 🤝 Shared-trip functionality, AI-powered travel features
...
A Netflix-inspired UI clone from 2022, showcasing frontend development and interface-building work.
**🛠️ Stack:** `HTML` `CSS` `JavaScript`
👉 **[View Repository →](https://github.com/RatneshPathak/OldNetflixUI-Clone-2022)**
...
| 🏛️ **Recognition** | Permanently featured on UG & PG college websites, official banners, and college magazines |
...
| 🌐 **Community & Leadership** | Student Council Member · Documentation Head · Event Organizer · Head Core (Freshers & Farewell) · Student Coordinator, ONGC-NIO · Contingent Leader, CC Phoenix |
...
[![GitHub Streak](https://streak-stats.demolab.com?user=RatneshPathak&theme=dark&hide_border=true)](https://git.io/streak-stats)
...
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:pathakratnesh03@gmail.com)
